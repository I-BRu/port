...
onMounted(async () => {
	...
	try {
		...
		const banners = repositories.map((repo) => repo.githubBanner ?? repo.banner);
				...
				<div class="column is-flex-desktop is-flex-wrap-wrap p-0">
					...
					>
						...
						<a :href="repo.url" target="_blank" rel="noopener noreferrer">
							...
							<div class="column is-narrow p-0 is-clickable github-banner">
								...
								<div class="column banner p-0">
									...
									<img
										...
										:src="repo.githubBanner ?? repo.banner"
